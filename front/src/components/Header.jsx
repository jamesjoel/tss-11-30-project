...
const Header = () => {
  ...
  let hideOffset = ()=>{
    offsetRef.current.classList.remove("show");
    let ele = document.querySelectorAll(".offcanvas-backdrop");
    ele.forEach(el => {
      ...
      <div className="row justify-content-between align-items-center" style={{width : "105%"}}>
        ...
        <div className="col-auto">
          <button style={{position : "relative", left : -20}} className="navbar-toggler border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar"
            ...
            <i class="fa fa-bars" style={{fontSize : 20}} aria-hidden="true"></i>
          </button>
          <a className="logo navbar-brand text-white" href="index.html">
        ...
        <div className="col-auto">
          ...
          <div ref={offsetRef} className={`offcanvas offcanvas-end`} tabIndex="-1" id="offcanvasNavbar"
            aria-labelledby="offcanvasNavbarLabel">
            <button onClick={hideOffset} style={{position : "absolute", right : 10, top : 10}} className='d-hide-md btn-close'></button>
            <div className="offcanvas-body">
              
              <ul className="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                <li className="nav-item">
                  <NavLink onClick={hideOffset} className="nav-link" to="/">Home</NavLink>
                  
                </li>
                <li className="nav-item">
                  <CategoryDropDown2 hideOffset={hideOffset} />
                  
                </li>
               
                <li className="nav-item">
                  <NavLink onClick={hideOffset} className="nav-link" to="/contact">Contact</NavLink>
                </li>
                {
                  !userLoggedIn
                  ?
                  <>
                  <li className="nav-item">
                  <NavLink onClick={hideOffset} className="nav-link" to="/login">Login</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink onClick={hideOffset} className="nav-link" to="/signup">Signup</NavLink>
                </li>
                  </>
                  :
                  ''
        ...
        <div className="col-5 col-lg-auto">
          <ul className="list-unstyled d-flex" style={{marginLeft : "-30px", marginTop : 5}}>
            ...
            
            {
              userLoggedIn
              ?
              <li className="d-lg-block dropdown d-hide-sm">
            ...
            <li className='nav-link you'>
              {
                userLoggedIn
                ?
                <NavLink className="border border-dark py-1 px-2 rounded" to='/user/myaccount'><i className='fa fa-user'></i> You</NavLink>
                :
                <NavLink className="border border-dark py-1 px-2 rounded" to='/login'><i className='fa fa-user'></i> Login</NavLink>
